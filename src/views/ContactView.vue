...
const { withFormLoading } = useSmartLoading();
...
async function submitForm() {
  ...
  try {
    // Utiliser le système de loading intelligent
    await withFormLoading(async () => {
      // Simuler l'envoi du formulaire avec un délai réaliste
...
<template>
  <main class="flex-grow pt-36 pb-16">
    <div class="container mx-auto px-4">
      ...
      >
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 transition-all hover:shadow-xl">
          ...
          <!-- Formulaire avec loading intelligent -->
