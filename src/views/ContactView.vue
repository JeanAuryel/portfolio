...
<template>
  <main class="flex-grow pt-20 pb-16">
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 transition-all hover:shadow-xl">
          ...
          <div class="space-y-6">
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <a href="mailto:jean-auryel.akinotcho@example.com" class="text-blue-500 hover:underline">jeanauryel.akinotcho@gmail.com</a>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <a href="tel:+33612345678" class="text-blue-500 hover:underline">+33 7 84 76 08 80</a>
              </div>
            </div>
          ...
          <div class="mt-10">
            ...
            <div class="flex space-x-4">
              <a href="https://linkedin.com" target="_blank" class="p-3 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-full hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">
                <span class="sr-only">LinkedIn</span>
                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </a>
              <a href="https://github.com" target="_blank" class="p-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
              ...
              <a href="https://twitter.com" target="_blank" class="p-3 bg-blue-50 dark:bg-blue-950 text-blue-400 dark:text-blue-300 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors">
      ...
      <!-- Carte Google Maps -->
      <div 
        class="mt-16 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 overflow-hidden transition-all hover:shadow-xl"
        :class="{ 'opacity-100': isLoaded, 'opacity-0': !isLoaded }"
        style="transition: opacity 0.7s ease-in-out 0.6s;"
      >
        <h2 class="text-2xl font-bold mb-6">Me localiser</h2>
